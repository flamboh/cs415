...
\section{Conclusion}
Overall, this was the hardest project so far. Project 1 was mostly parsing and syscalls, and Project 2 was mostly signal ordering. In this project, I had to model the actual park rules carefully enough that the synchronization followed from the data. The final version uses explicit passenger and car states, queue ordering, condition variables, broadcasts, and a pipe-based monitor process. The result supports multiple passengers and cars, partial-car departures after the wait period, ordered unloading, clean shutdown, and live queue monitoring.
\end{document}
